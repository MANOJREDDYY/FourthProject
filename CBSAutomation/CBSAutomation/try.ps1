...
&$NunitDir  $TestDLL --test=CBSAutomation.TestScripts.Smoke_Test_Scripts.ToolCreation  --labels=off --work=$reportNunitInputpath --result="Project.SmokeCases.Test.xml;format=nunit3" 
