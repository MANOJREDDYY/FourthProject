...
namespace CBSAutomation.TestScripts.Estimate_Test_Cases
{
    [TestFixture]
    [Order(8)]
    class MarktoAnyShiptoTest:Driver
    {
        ...
        public void reportGeneration()
        {
            ...
            string reportname = "Mark to any shipto for range price";
        ...
        [Test]
        public void MarktoAnyshiptoRangepriceTest1()
        {
        ...
        [Test]
        public void MarktoAnyshiptoRangepriceTest2()
        {
            test = extendtreports.CreateTestwrap("Create Business Estimate for the product spec withRange pricing ");
            ...
            shiptoadd = SpecificationPage.CreateBusinessSpecificationwithPricingType(this.driver, test,CostModel, Qty, Unitization);
          //  shiptoadd = SpecificationPage.CreateBussSpecWithoutApproveEst3(CostModel, Qty, Unitization);
           
        }
        [Test]
        public void MarktoAnyshiptoRangepriceTest3()
        {
      ...
      string OrderSpecID = excelFile.GetTestInputValue("SPECIFICATION", "Create_Specification", "Create_RSC_makeBoard", "SPECID");
            ...
            public void BrowserLogout()
        {
            try
            {
                ...
                extendtreports.LogTestStatus("Create spec  for RSC style spec and  for product and validate for mark for any ship to for range price  ");
