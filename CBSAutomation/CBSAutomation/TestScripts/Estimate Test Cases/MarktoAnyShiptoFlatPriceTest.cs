...
namespace CBSAutomation.TestScripts.Estimate_Test_Cases
{
    [TestFixture]
    [Order(6)]
    class MarktoAnyShiptoFlatPriceTest:Driver
    {
        ...
        public void reportGeneration()
        {
            ...
            string reportname = "Mark to any ship to Flat price type";
        ...
        [Test]
        public void MarktoAnyshiptoTest1()
        {
        ...
        [Test]
        public void MarktoAnyshiptoTest2()
        {
        ...
        [Test]
        public void MarktoAnyshiptoTest3()
        {
      ...
      string OrderSpecID = excelFile.GetTestInputValue("SPECIFICATION", "Create_Specification", "Create_RSC_makeBoard", "SPECID");
            ...
            public void BrowserLogout()
        {
            try
            {
                ...
                extendtreports.LogTestStatus("Create spec  for RSC style spec and  for product and validate for mark for any ship to ");
