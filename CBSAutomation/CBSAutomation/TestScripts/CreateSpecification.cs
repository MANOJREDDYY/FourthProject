    ...
    class CreateSpecification
    {
        ...
        public void CreateProductSpecTest2()
        {
           ...
           //  string mdsd = "AutoSpecID_" + CommonFunctions.RandomString(2);
            ...
            SpecificationPage.CreateProductSpecificationNext(Spec_Length, Spec_Width, Spec_Depth, SpecMaterial, PrintToolID);
        ...
        {
            extent.CreateTest("Create Order for RSC style spec ", "create a spec for product with external material and RSC product style");
